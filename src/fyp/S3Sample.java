...
public class S3Sample {
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			/*
			 * Plural DeleteObjects fails even with all the settings above.
			 * Singular DeleteObject works fine so far as we have tested
			 */
			System.out.println("Deleting objects\n");
			DeleteObjectsRequest deleterequest = new DeleteObjectsRequest(bucketName).withKeys(key);
			...
			// Eucalyptus Code Changes BEGIN
			System.out.println("Program completed operation.\n");
			// Eucalyptus Code Changes END
